...
public class BinaryTree<T> where T : IComparable<T>//where 指定T从IComparable<T>继承
{
    /// <summary>
    /// 定义二叉树
    /// </summary>
    ...
    public void Insert(T newItem)
    {
        ...
        if (currentNodeValue.CompareTo(newItem) > 0)
        {
            ...
            {
                this.LeftTree = new BinaryTree<T>(newItem);
            }
            else
            {
        ...
        else
        {
            ...
            {
                this.RightTree = new BinaryTree<T>(newItem);
            }
            else
            {
    ...
    public void PreOrderTree(BinaryTree<T> root)
    {
        if (root != null)
        {
    ...
    /// </summary>
    /// <param name="root"></param>
    public void PostOrderTree(BinaryTree<T> root)
    {
        if (root != null)
        {
